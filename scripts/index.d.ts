...
export function canEquip(itemOrFamiliar: Familiar): boolean;
...
export class Effect extends MafiaClass {
    ...
    /**
     * All */
    readonly all: { [key: string]: boolean };
    /**
     * Image */
    readonly image: string;
    /**
...
export class Monster extends MafiaClass {
    ...
    /**
     * Images */
    readonly images: { [key: string]: boolean };
    /**
     * Sub types */
    readonly subTypes: { [key: string]: boolean };
    /**
     * Random modifiers */
    readonly randomModifiers: { [key: string]: boolean };
    /**
     * Manuel name */
